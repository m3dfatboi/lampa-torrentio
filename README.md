...
- Для сериалов берёт IMDb ID через TMDB TV endpoint и тянет `/stream/series/{imdb}.json`.
...
```
[Torrentio] plugin source loaded v10-series-tmdb-type
...
[Torrentio] Lampa.Template.get hooked v10-series-tmdb-type
[Torrentio] Lampa.Parser.get hooked v10-series-tmdb-type
```
